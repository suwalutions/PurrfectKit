...
class Suphalaks:
    """
    A utility class for handling files, loading models, and creating document templates.
    ...
    document_template(chunks, metadata)
